...
def main() -> None:
    ...
    # tablets_path = os.path.join(BASE_DIR, "tablets_data_files")
    ...
    # result = clean_agent_output(agents.extract_answer(question="Quantos novos clientes compraram este mês?"))
    # print(result)
